...
| `idgen-reproduction/` | The original IDGenV0 false-positive pattern: SQS DLQ recursion, sync Lambda, polled-async Lambda, DDB TTL — exercises four of the engine's reasoning axes in one PR. |
