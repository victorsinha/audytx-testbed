...
locals {
  ...
  # /20 subnets carved from the VPC CIDR; public range offset to avoid overlap.
...
# Private subnets host the Fargate tasks and RDS.
...
# VPC flow logs to CloudWatch for network visibility.
