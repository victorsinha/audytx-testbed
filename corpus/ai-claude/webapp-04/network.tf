...
# --- NAT gateways (one per AZ) so private ECS tasks can pull images / reach AWS APIs ---
...
# --- Private route tables (one per AZ, each via its own NAT) ---
...
# --- Database route table (no default route = isolated) ---
