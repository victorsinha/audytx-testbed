# Internet-facing ALB in the public subnets, fronting the ECS service.
# HTTPS-only: HTTP listener redirects to HTTPS. Access logs to S3.
...
# --- ALB access-log bucket (encrypted, private, versioned) -----------------
